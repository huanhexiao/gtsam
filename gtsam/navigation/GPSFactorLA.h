 ...
 */
class GTSAM_EXPORT GPSFactorLA: public NoiseModelFactor1<Pose3> {
...
private:
  ...
  boost::optional<Point3>
      body_t_;  ///< Lever arm, i.e., antenna position in body frame

 public:

  /// shorthand for a smart pointer to a factor
  typedef boost::shared_ptr<GPSFactorLA> shared_ptr;

  /// Typedef to this class
  typedef GPSFactorLA This;

  /** default constructor - only use for serialization */
  GPSFactorLA(): nT_(0, 0, 0) {}
   ...
   */
  GPSFactorLA(Key key, const Point3& gpsIn, const SharedNoiseModel& model,
              boost::optional<Point3> body_t = boost::none)
      : Base(model, key), nT_(gpsIn), body_t_(body_t) {}
